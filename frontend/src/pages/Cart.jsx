                                ...
                                <div className="flex justify-between items-center pr-7">
                                    <div className="flex items-center w-[ 350px]">
                                        <img
                                            ...
                                            alt="" className="w-35 h-35"
                                        />
                                        <div className="w-[ 280px]">
                                            <h1 className="font-semibold line-clamp-1 ">{product?.productId?.productName}</h1>
                                            <p className="">₹{product?.productId?.productPrice} </p>
                                        </div>
                                    </div>
