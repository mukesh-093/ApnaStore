                    ...
                    <div className="flex flex-col gap-3">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="grid gap-2">
                                ...
                                <Input id="firstName" name="firstName" type="text" placeholder="Mukesh" required value={formData.firstName} onChange={handelChange} />
                            </div>
                            <div className="grid gap-2">
                                <label htmlFor="lastName">Last Name</label>
                                <Input id="lastName" name="lastName" type="text" placeholder="Kumar" required value={formData.lastName} onChange={handelChange}/>
                            </div>
                        </div>
                        <div className="grid gap-2">
                        ...
                        <div className="relative">
                            <Input id="password" name="password" placeholder="Create a password" type={showPassword ? 'text' : 'password'}  required  value={formData.password} onChange={handelChange}/>
                            {
