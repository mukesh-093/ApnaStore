            ...
            <Card className="w-full max-w-sm">
                ...
                <CardContent>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="relative">
                            <Input id="password" name="password" placeholder="Enter  a password" type={showPassword ? 'text' : 'password'}  required  value={formData.password} onChange={handelChange}/>
                            {
                ...
                <CardFooter className="flex-col gap-2">
                    ...
                    <p className="text-gray-700 text-sm">
                        Don't hava an account? <Link to={'/signup'} className="hover:underline cursor-pointer text-pink-800">SignUp</Link>  
                    </p>
